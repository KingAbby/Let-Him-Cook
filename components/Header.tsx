...
const Header: React.FC<HeaderProps> = ({
        ...
        return (
            <View style={styles.headerContainer} className="w-full absolute z-50">
                ...
                <View className={`items-center justify-between px-4 py-3 ${className}`}>
                    <Text className="text-gray-800 text-lg font-semibold" style={{ textShadowColor: 'rgba(255, 255, 255, 0.5)', textShadowOffset: { width: 0, height: 1 }, textShadowRadius: 2 }}>{title}</Text>
    ...
    return (
        <View style={styles.headerContainer} className="w-full absolute z-50">
            ...
            <SafeAreaView className={`w-full px-5 py-2 flex-row items-center ${className}`}>
