      ...
      >
        ...
        <View className="items-center px-4 pt-6 pb-8">
          ...
          {avatarUrl ? (
            ...
            <View
              className="h-28 w-28 rounded-full bg-blue-500 items-center justify-center mb-4"
              style={{
                shadowColor: "#000",
                shadowOffset: { width: 0, height: 2 },
                shadowOpacity: 0.1,
          ...
          <TouchableOpacity
            ...
            className="bg-blue-500 px-5 py-2.5 rounded-full flex-row items-center"
          >
        ...
        {/* Sign Out Button */}
        <TouchableOpacity
          className="mx-4 mt-8 bg-red-500 rounded-xl py-3.5 items-center"
