...
import { View, Text, StatusBar, TouchableOpacity, ImageBackground, ScrollView, Platform } from 'react-native';
        ...
        const checkIfReturningUser = async () => {
            try {
                if (user) {
                    ...
                    const hasLoggedInBefore = await AsyncStorage.getItem(returningUserKey);
                    ...
                    <View className="mb-6">
                        ...
                        <View className="bg-white rounded-2xl shadow-md p-5">
                            <View className="flex flex-row justify-around">
                                <TouchableOpacity className="items-center" onPress={() => navigation.navigate(ROUTES.RECIPE)}>
                                ...
                                <TouchableOpacity className="items-center" onPress={() => navigation.navigate(ROUTES.NOTES)}>
                                ...
                                <TouchableOpacity className="items-center" onPress={() => console.log('Favorites')}>
