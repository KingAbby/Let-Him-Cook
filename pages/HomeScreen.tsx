...
const HomeScreen = ({ navigation }) => {
    ...
    const fetchInspirationRecipes = async () => {
        try {
            ...
            console.error('Error fetching inspiration recipes:', error);
        }
    };
    ...
    const renderCarouselItem = ({ item }) => (
        <View style={{ width: screenWidth - 40 }} className='bg-white rounded-2xl shadow-md overflow-hidden mx-5 my-3'>
            <View className='h-40'>
                <Image
                ...
                <View className='py-6 flex-col gap-6'>
                    ...
                    <View>
                        ...
                        {inspirationRecipes.length > 0 ? (
                            ...
                            <View className='bg-white rounded-2xl shadow-md overflow-hidden mx-5'>
